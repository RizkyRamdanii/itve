...
<footer class="footer bg-blue-400 text-black p-10">
	...
	<nav>
		...
		<a href="#Hero" on:click|preventDefault={scrollIntoView} class="link link-hover">Home</a>
		<a href="#About" on:click|preventDefault={scrollIntoView} class="link link-hover">About</a>
		<a href="#Offer" on:click|preventDefault={scrollIntoView} class="link link-hover"
			>Scope Of Work</a
		>
		<a href="#Testi" on:click|preventDefault={scrollIntoView} class="link link-hover"
			>Testimonials</a
		>
	</nav>
</footer>
<footer class="footer bg-blue-400 text-black border-blue-200 border-t-2 px-10 py-4">
	...
	<nav class="md:place-self-center md:justify-self-end">
		<div class="grid grid-flow-col gap-4">
			<a href="https://www.instagram.com/itve_production/">
			...
			<a href="https://shopee.co.id/itveproduction">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					x="0px"
					y="0px"
			...
			<a href="https://www.facebook.com/profile.php?id=100095350874163">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
